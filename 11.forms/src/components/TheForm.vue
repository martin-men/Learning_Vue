<template>
  <form @submit.prevent="submitForm()">
    ...
    <div class="form-control">
      ...
      <!-- v-model.number is a modifier that tells Vue to convert the input value to a number. -->
    ...
    <!-- When there is a single checkbox the received value is a boolean -->
    <div>
      <input type="checkbox" name="agree" id="agree" v-model="confirm">
